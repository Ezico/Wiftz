          ...
          <div class="aside-menu flex-column-fluid">
            ...
            >
              ...
              >
                ...
                >
                  <span class="menu-link">
                    ...
                    <Link to="/admin/create-resources?resource-new">
                      <span class="menu-title">Create Resources</span>
                    </Link>
                  </span>
              ...
              >
                ...
                <div class="menu-item">
                  {/* <!--begin:Menu link--> */}
                  <Link class="menu-link" to="/admin/resources/editor">
                    <span class="menu-icon">
                      {/* <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg--> */}
                      <span class="svg-icon svg-icon-2">
                        <svg
                    ...
                    <Link to="/admin/resources/editor">
                      <span class="menu-title">Resources Page Editor</span>
                    </Link>
                  </Link>
                  {/* <!--end:Menu link--> */}
                </div>
                <div class="menu-item">
                  {/* <!--begin:Menu link--> */}
                  <Link class="menu-link" to="/admin/legal/editor">
                    <span class="menu-icon">
                      {/* <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg--> */}
                      <span class="svg-icon svg-icon-2">
                        <svg
