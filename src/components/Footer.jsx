        ...
        <div className="wrapper">
          <div className="row pt-50">
            ...
            <div className="col-md-3 footer-details">
              <div className="heading">Find out more</div>
              <ul>
                <Link to="/about">
                  <li>About</li>
                </Link>
            ...
            <div className="col-md-3 footer-details">
              ...
              <div className="social-links">
                ...
                <a className="social-ico" href={data?.twitter}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <a className="social-ico" href={data?.linkedin}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <a className="social-ico" href={data?.facebook}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <a className="social-ico" href={data?.tictok}>
                  <img
                    src={Tictok}
                    alt={data?.instagram}
                    style={{
            ...
            <div className="hide-large pt-50"></div>
            <div className="hide-large col-md-3 footer-logo">
              <img src={Logo} alt="site logo" />
            </div>
          </div>
          <br />
